...
function startsWithDarkHero(pathname) {
  ...
  if (pathname === "/about" || pathname === "/producers" || pathname === "/mill-journey") return true;
  return false;
}
      ...
      <header className={`site-header ${scrolled ? "site-header--scrolled" : ""} ${!darkHero && !scrolled ? "site-header--on-light" : ""}`}>
        <div className="site-header__inner container">
          ...
          <nav className="site-header__nav site-header__nav--left">
            ...
            <NavLink to="/mill-journey" className="nav-link">The Mill</NavLink>
          </nav>
      ...
      <div className={`mobile-menu ${menuOpen ? "mobile-menu--open" : ""}`}>
        <div className="mobile-menu__inner">
          ...
          <ul className="mobile-menu__links">
            ...
            <li><NavLink to="/mill-journey" onClick={() => setMenuOpen(false)}>The Mill</NavLink></li>
